...
<div class="container_buttons_socials">
    ...
    <div class="buttons_facebook">
        ...
        <div class="fb-like" data-href="http://www.favaratotrade.com/portal/es/inicio" data-layout="button_count" data-action="like" data-show-faces="false" data-share="true"></div>
    </div>
    <!-- /BUTTONS SOCIAL FACEBOOK -->

    <!-- BUTTONS SOCIAL TWITTER -->
    <div class="buttons_twitter">
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.favaratotrade.com/portal/es/inicio" data-via="FavaratoExpress" data-lang="<?php echo $language; ?>">Twittear</a>
        <script>
            !function(d,s,id){
    ...
    <div class="buttons_linkedin">
        ...
        <script type="IN/Share" async data-url="http://www.favaratotrade.com/portal/es/inicio" data-counter="right"></script>
    </div>
    <!-- /BUTTONS SOCIAL LINKEDIN -->
