...
<?php foreach ($js_scripts as $js_scripts) { ?>
    <script type="text/javascript" src="<?php echo URL_JS; ?><?php echo $js_scripts; ?>.js"></script>
<?php } ?>
...
<script type="text/javascript" src="<?php echo URL_JS ?>superfish.js"></script>
<script type="text/javascript" src="<?php echo URL_JS ?>jquery.sticky.js"></script>
<script type="text/javascript" src="<?php echo URL_JS ?>imagesloaded.pkgd.min.js"></script>
<script type="text/javascript" src="<?php echo URL_JS ?>spectrum.js"></script>
...
<script type="text/javascript" src="<?php echo URL_JS ?>nubes.js"></script>
<script type="text/javascript" src="<?php echo URL_JS ?>jquery.polyglot.language.switcher.js" type="text/javascript"></script>
