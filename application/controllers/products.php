...
class Products extends CI_Controller {
    ...
    public function category($val_categoria, $subcategoria) {
        ...
        if ($val_categoria == 'wholesale-clothing' && $subcategoria == '') {
        ...
        } else if ($val_categoria == 'wholesale-clothing' && $subcategoria == 'children') {
        ...
        } else if ($val_categoria == 'wholesale-clothing' && $subcategoria == 'woman') {
        ...
        } else if ($val_categoria == 'wholesale-clothing' && $subcategoria == 'man') {
        ...
        } else if ($val_categoria == 'wholesale-jewelry' && $subcategoria == '') {
        ...
        $data["categorias"] = $this->productos_categoria_model->productos_categoriaQry(Array('L-PRODUCTO-PORTAL-CATEGORIA-CRITERIO', $idioma, ''));

        // VALORES PARA LA CATEGORIA
        $this->productos_categoria_model->productos_categoriaGetDatos(Array('L-PRODUCTO-PORTAL-CATEGORIA-CRITERIO', $idioma, rawurldecode($categoria)));
        $data['code_cat'] = $this->productos_categoria_model->getCatId();
        $data['name_categoria'] = $this->productos_categoria_model->getCatDescripcionEs();

        // VALORES PARA LA SUBCATEGORIA
        $this->productos_categoria_model->productos_categoriaGetDatos(Array('L-PRODUCTO-PORTAL-CRITERIO-SUBCATEGORIAS', $idioma, rawurldecode($subcategoria)));
        if ($this->productos_categoria_model->getCatId() == "") {
            $code_subcat = "sin_sc";
        } else {
            $code_subcat = $this->productos_categoria_model->getCatId();
        }

        if ($this->productos_categoria_model->getCatDescripcionEs() == "") {
            $desc_subcat = "sin_sc";
        } else {
            $desc_subcat = $this->productos_categoria_model->getCatDescripcionEs();
        }
    ...
    function qryProductos($pag = null) {
        ...
        $this->productos_categoria_model->productos_categoriaGet(Array('L-PRODUCTO-CATEGORIA-CODIGO', $idioma, $codigo));

        if ($idioma == "es") {
            $valor = $this->productos_categoria_model->getCatDescripcionEs();
        } else {
            $valor = $this->productos_categoria_model->getCatDescripcionEn();
        }
    ...
    public function product_info($codigo) {
        ...
        $this->productos_categoria_model->productos_categoriaGet(Array('L-PRODUCTO-CATEGORIA-CODIGO', $idioma, $cadena[2]));

        if ($idioma == "es") {
            $descripcion_categoria = replace_caracteres_raros(strtolower($this->productos_categoria_model->getCatDescripcionEs()));
        } else {
            $descripcion_categoria = replace_caracteres_raros(strtolower($this->productos_categoria_model->getCatDescripcionEn()));
        }

        $categoria = $descripcion_categoria;

        /* Obtener la SubCategoria del Producto */
        $this->productos_categoria_model->productos_categoriaGet(Array('L-PRODUCTO-CATEGORIA-CODIGO', $idioma, $cadena[3]));

        if ($idioma == "es") {
            $descripcion_subcategoria = replace_caracteres_raros(strtolower($this->productos_categoria_model->getCatDescripcionEs()));
        } else {
            $descripcion_subcategoria = replace_caracteres_raros(strtolower($this->productos_categoria_model->getCatDescripcionEn()));
        }

        $subcategoria = $descripcion_subcategoria;

        if ($categoria == 'clothing' && $subcategoria == '') {
            $title_bread = lang('idioma.productos-ropa');
            $url_bread = lang('idioma.controlador-productos-ropa');
        } else if ($categoria == 'clothing' && $subcategoria == 'children') {
            $title_bread = lang('idioma.productos-ropa-de-ninos');
            $url_bread = lang('idioma.controlador-productos-ropa-ninos');
        } else if ($categoria == 'clothing' && $subcategoria == 'woman') {
            $title_bread = lang('idioma.productos-ropa-de-mujer');
            $url_bread = lang('idioma.controlador-productos-ropa-mujer');
        } else if ($categoria == 'clothing' && $subcategoria == 'man') {
            $title_bread = lang('idioma.productos-ropa-de-hombre');
            $url_bread = lang('idioma.controlador-productos-ropa-hombre');
        } else if ($categoria == 'jewelry' && $subcategoria == '') {
            $title_bread = lang('idioma.productos-joyeria');
            $url_bread = lang('idioma.controlador-productos-joyeria');
        } else if ($categoria == 'makeup' && $subcategoria == '') {
            $title_bread = lang('idioma.productos-maquillaje');
            $url_bread = lang('idioma.controlador-productos-maquillaje');
        } else if ($categoria == 'baby-items' && $subcategoria == '') {
            $title_bread = lang('idioma.productos-articulosbebe');
            $url_bread = lang('idioma.controlador-productos-articulosbebe');
        } else if ($categoria == 'housewares' && $subcategoria == '') {
            $title_bread = lang('idioma.productos-prohogar');
            $url_bread = lang('idioma.controlador-productos-prohogar');
        } else if ($categoria == 'toys' && $subcategoria == '') {
            $title_bread = lang('idioma.productos-juguetes');
            $url_bread = lang('idioma.controlador-productos-juguetes');
        }
    ...
    function productosGet($nProdId) {
        ...
        if ($query) {
            ...
            $data['categoria'] = $this->productos_model->getProdCategoria();
            $data['nSubCatID'] = $this->productos_model->getProdSubCatId();
            $data['subcategoria'] = $this->productos_model->getProdSubCategoria();
