...
//        $this->connectionInfo = array("Database" => "bdMptIntegradaCI", "UID" => "sa", "PWD" => "sqlserver@mpt2012p", "CharacterSet" => 'UTF-8');
        $this->serverName = "LUIGGI-PC"; //serverName\instanceName
        $this->connectionInfo = array("Database" => "bdMptIntegradaCI", "UID" => "desarrollo2", "PWD" => "@desarrollo123@", "CharacterSet" => 'UTF-8');
